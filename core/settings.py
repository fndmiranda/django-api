...
APP_NAME = os.environ.get('APP_NAME', 'Django Api')

APP_DESCRIPTION = os.environ.get('APP_DESCRIPTION', 'The Django Api skeleton application')
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_PAGINATION_CLASS': 'base.pagination.SimplePagination',
    'PAGE_SIZE': 15,
